...
set -x
jq -s '.[0] * {"channel_group":{"groups":{"Application":{"groups": {"Org3MSP":.[1]}}}}}' config.json ./.dist/organizations/peer-organizations/org3.example.com/org3.json > modified_config.json
{ set +x; } 2>/dev/null
